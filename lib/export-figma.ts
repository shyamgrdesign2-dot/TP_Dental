...
function buildTokensStudio(): object {
  ...
  semantic["cta-specs"] = {
    ...
    "primary-hover-shadow": { value: "0 4px 14px rgba(75,74,213,0.18)", type: "boxShadow", description: "Primary CTA hover shadow" },
    "outline-hover-bg": { value: "rgba(255,255,255,0.22)", type: "color", description: "Outline CTA hover bg on dark surface" },
    "outline-hover-border": { value: "rgba(255,255,255,0.70)", type: "color", description: "Outline CTA hover border on dark surface" },
    "outline-hover-glow": { value: "0 0 16px rgba(255,255,255,0.12)", type: "boxShadow", description: "Outline CTA hover glow on dark surface" },
    "danger-bg": { value: "#E11D48", type: "color", description: "Danger bg" },
    "danger-hover": { value: "#BE123C", type: "color", description: "Danger hover" },
    "secondary-bg": { value: "#F1F1F5", type: "color", description: "Secondary/neutral CTA bg" },
    "secondary-hover": { value: "#E2E2EA", type: "color", description: "Secondary CTA hover bg" },
    ...
    "active-scale": { value: "0.97", type: "other", description: "Active press scale transform" },
    "split-hover-brightness": { value: "1.12", type: "other", description: "Split button hover brightness filter" },
    "split-hover-shadow": { value: "0 4px 6px -1px rgba(0,0,0,0.1)", type: "boxShadow", description: "Split button container hover shadow" },
    radius: { value: "10", type: "borderRadius", description: "CTA radius 10px" },
