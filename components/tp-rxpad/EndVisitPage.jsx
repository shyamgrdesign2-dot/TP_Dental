...
import { ArrowDown2, ClipboardText, DocumentDownload, Edit2, LanguageSquare, Printer, ReceiptText, Setting2, User } from "iconsax-reactjs";
import { ChevronLeft, ChevronRight } from "lucide-react";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@/components/ui/dropdown-menu";
import { RxPreviewDocument } from "@/components/tp-rxpad/RxPreviewDocument";
import { PrintSettingsDrawer } from "@/components/tp-rxpad/PrintSettingsDrawer";
import { getComposedRxPreviewSnapshot } from "@/components/tp-rxpad/rx-preview-composer";
import { TPConfirmDialog, TPSnackbar } from "@/components/tp-ui";
...
export function EndVisitPage() {
    ...
    const openDentalPlan = () => {
        const q = new URLSearchParams();
        q.set("patientId", patientId);
        q.set("from", "rxpad");
        q.set("planTab", "estimates");
        router.push(`/treatment-plan?${q.toString()}`);
    };
