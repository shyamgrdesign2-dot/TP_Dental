      ...
      {open ? (
        <aside
          className={cn(
            ...
            /* md+: dock right, below 62px app header — page stays full width; panel only covers main band */
            "md:inset-x-auto md:bottom-0 md:left-auto md:right-0 md:top-[62px] md:max-h-none md:w-[clamp(350px,25vw,400px)] md:max-w-[400px] md:border-l md:border-t-0",
          )}
          aria-label="Dr. Agent"
        >
          <DrAgentPanel
