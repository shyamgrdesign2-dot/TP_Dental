...
interface AttachPanelProps {
  onSelect: (docType: "pathology" | "radiology" | "prescription" | "dental_radiology") => void
  onClose: () => void
}

const DUMMY_FILES: {
  docType: "pathology" | "radiology" | "prescription" | "dental_radiology"
  name: string
  size: string
  pages: number
  iconName: string
  ...
  {
    docType: "dental_radiology",
    name: "OPG_Panoramic_Scan.pdf",
    size: "2.1 MB",
    pages: 1,
    iconName: "medical service",
    iconColor: "#0891B2",
