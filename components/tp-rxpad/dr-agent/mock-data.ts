...
export const SMART_SUMMARY_BY_CONTEXT: Record<string, SmartSummaryData> = {
  ...
  "__patient__": {
    ...
    patientNarrative:
      "25-year-old male presenting with Fever since 3 days with evening spikes, Dry Cough 2 days, and Eye Redness bilateral. Known Diabetes (1yr) and Hypertension (6mo), on Telma 20mg and Metsmail 500mg. Allergic to Dust and Egg. Dental: upper left T22 implant crown (hygiene review), T24 caries watch buccal with aging sealant.",
    ...
    lastVisit: {
      ...
      examination:
        "Eyes: Conjunctival congestion bilateral mild, Chest: Clear, Throat: Mild pharyngeal congestion. Dental: U/L quadrant — T22 implant crown (peri-implant plaque buccal), T24 occlusal sealant with buccal caries watch (bitewing due)",
    ...
    symptomCollectorData: {
      ...
      lastVisitSummary:
        "last visited on 27 Jan'26 with fever, diagnosed Viral fever and Conjunctivitis, suggested Paracetamol 650mg and Azithromycin 500mg; dental review T22 implant hygiene and T24 caries surveillance",
      isNewPatient: false,
    },
  },
...
export const PATIENT_DOCUMENTS: Record<string, PatientDocument[]> = {
  "__patient__": [
    {
      id: "doc-dental-opg",
      fileName: "OPG_Panoramic_Mar2026.pdf",
      docType: "dental_radiology",
      uploadedAt: "08 Mar'26",
      uploadedBy: "Dental Imaging",
      pageCount: 1,
      size: "2.4 MB",
    },
