...
export const RX_CONTEXT_OPTIONS: RxContextOption[] = [
  ...
  /** Same person as __patient__ — used when RxPad URL uses ?patientId=apt-1 */
  { id: "apt-1", label: "Shyam GR", meta: "M, 25y · PAT0061 · Dental", kind: "patient", isToday: true, gender: "M", age: 25 },
  ...
  /** Same patient as apt-anjali — queue / RxPad URL id from appointment-patients */
  { id: "apt-6", label: "Anjali Patel", meta: "F, 28y · PAT0067 · 9988771122", kind: "patient", isToday: true, gender: "F", age: 28 },
...
/** Canned / welcome action — opens medical records flow (multi-select + upload) */
export const UPLOAD_MEDICAL_RECORDS_MESSAGE = "Upload medical records for this patient"
