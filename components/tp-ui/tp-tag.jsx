...
export function TPTag({ children, color = "blue", variant = "light", size = "md", icon, onRemove, className, }) {
    return (_jsxs("span", { className: cn("inline-flex items-center rounded-md border font-medium", colorVariantStyles[color][variant], sizeStyles[size], className), children: [icon && _jsx("span", { className: "shrink-0", children: icon }), _jsx("span", { className: "truncate", children: children }), onRemove && (_jsx("button", { type: "button", onClick: onRemove, className: "shrink-0 opacity-60 hover:opacity-100 transition-opacity", "aria-label": "Remove", children: _jsx(X, { size: size === "sm" ? 12 : 14 }) }))] }));
}
