...
export function RxPadFunctional() {
    ...
    return (_jsxs("div", { className: rx.rxRoot, children: [
        _jsx(EditableTableModule, { id: "symptoms", title: "Chief Complaints", icon: _jsx(TPMedicalIcon, { name: "Virus", variant: "bulk", size: 24, color: "var(--tp-violet-500)" }), columns: symptomsColumns, primaryKey: "name", rows: symptomRows, onChangeRows: setSymptomRows, searchPlaceholder: "Search & Add Chief Complaint", searchSuggestions: symptomSuggestions, cannedChips: symptomSuggestions.slice(0, 12) }),
        _jsx(EditableTableModule, { id: "examinations", title: "Examinations", icon: _jsx(TPMedicalIcon, { name: "medical service", variant: "bulk", size: 24, color: "var(--tp-violet-500)" }), columns: examinationsColumns, primaryKey: "name", rows: examinationRows, onChangeRows: setExaminationRows, searchPlaceholder: "Search & Add Examinations", searchSuggestions: examinationSuggestions, cannedChips: examinationSuggestions.slice(0, 12), pulseRowIds: examinationPulseIds }),
        _jsx(EditableTableModule, { id: "diagnosis", title: "Diagnosis", icon: _jsx(TPMedicalIcon, { name: "Diagnosis", variant: "bulk", size: 24, color: "var(--tp-violet-500)" }), columns: diagnosisColumns, primaryKey: "name", rows: diagnosisRows, onChangeRows: setDiagnosisRows, searchPlaceholder: "Search & Add Diagnosis", searchSuggestions: diagnosisSuggestions, cannedChips: diagnosisSuggestions.slice(0, 12) }),
        _jsx(EditableTableModule, { id: "lab", title: "Investigations", icon: _jsx(TPMedicalIcon, { name: "Test Tube", variant: "bulk", size: 24, color: "var(--tp-violet-500)" }), columns: labColumns, primaryKey: "investigation", rows: labRows, onChangeRows: setLabRows, searchPlaceholder: "Search & Add Investigation", cannedChips: LAB_INVESTIGATION_BASE_OPTIONS }),
        _jsx(EditableTableModule, { id: "medication", title: "Medication (Rx)", icon: _jsx(TPMedicalIcon, { name: "Tablets", variant: "bulk", size: 24, color: "var(--tp-violet-500)" }), columns: medicationColumns, primaryKey: "medicine", rows: medicationRows, onChangeRows: setMedicationRows, searchPlaceholder: "Search & Add Medication (Rx)", searchSuggestions: medicationSuggestions, cannedChips: [
            "Paracetamol 650mg",
            "Amoxicillin 500mg",
            "Pantoprazole 40mg",
            "Cetirizine 10mg",
        ...
        _jsx(EditableTableModule, { id: "advice", title: "Advice", icon: _jsx(TPMedicalIcon, { name: "health care", variant: "bulk", size: 24, color: "var(--tp-violet-500)" }), columns: adviceColumns, primaryKey: "advice", rows: adviceRows, onChangeRows: setAdviceRows, searchPlaceholder: "Search & Add Advice", cannedChips: ADVICE_SUGGESTIONS }),
        _jsxs("div", { className: rx.notesGrid, children: [
            _jsx(TPRxPadSection, { title: "Follow-up", icon: _jsx(Calendar2, { size: 24, variant: "Bulk", color: "var(--tp-violet-500)" }), showHeaderActions: false, children: _jsxs("div", { className: rx.followStack, children: [
                _jsx("input", { value: followUp, onChange: (event) => setFollowUp(event.currentTarget.value), className: rx.followInput, placeholder: "e.g. 3 days" }),
                _jsx("div", { className: rx.followQuickRow, children: ["2 days", "1 week", "1 month", "3 months"].map((quick) => (_jsx("button", { type: "button", className: rx.followQuick, onClick: () => setFollowUp(quick), children: quick }, quick))) }),
            ] }) }),
            _jsx(TPRxPadSection, { title: "Additional Notes", icon: _jsx(Notepad2, { size: 24, variant: "Bulk", color: "var(--tp-violet-500)" }), showHeaderActions: false, children: _jsx("textarea", { value: additionalNotes, onChange: (event) => setAdditionalNotes(event.currentTarget.value), rows: 5, className: rx.notesTextarea, placeholder: "Enter additional notes" }) }),
        ] }),
    ] }));
}
