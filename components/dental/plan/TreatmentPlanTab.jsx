...
import { PlanBookAppointmentBridge } from "./BookAppointmentDrawer";
...
export function TreatmentPlanTab({ patientId, patientAge = 30, initialTab = "estimates", initialDrawer, embedInPatientShell = false, }) {
    ...
    useEffect(() => {
        const u = searchParams?.get("planTab") || searchParams?.get("tab");
        if (u === "estimates" || u === "progress" || u === "completed")
            setActiveTab(u);
    }, [searchParams]);
