    ...
    return _jsxs("div", {
        ...
        children: [
            _jsxs("div", {
                ...
                children: [
                    _jsx("div", {
                        ...
                        children: _jsx("span", { className: "font-sans text-[14px] font-bold text-tp-blue-600", children: index + 1 }),
                    }),
                    _jsxs("div", {
                        className: "flex-1 min-w-0",
                        children: [
                            _jsx("p", { className: "font-sans text-[16px] font-bold text-tp-slate-900 truncate", children: plan.name }),
                            _jsx("div", {
                        ...
                        children: [
                            _jsx("thead", {
                                children: _jsxs("tr", {
                                    ...
                                    children: [
                                        ...
                                        _jsx("th", { className: "px-[8px] py-[7px] text-left font-sans text-[12px] font-semibold uppercase tracking-[0.5px] text-tp-slate-400 w-[70px]", children: "Surface" }),
                                        _jsx("th", { className: "px-[8px] py-[7px] text-right font-sans text-[12px] font-semibold uppercase tracking-[0.5px] text-tp-slate-400 w-[80px]", children: "Rate" }),
                                        _jsx("th", { className: "px-[8px] py-[7px] text-right font-sans text-[12px] font-semibold uppercase tracking-[0.5px] text-tp-slate-400 w-[60px]", children: "Disc." }),
                            ...
                            _jsx("tbody", {
                                children: plan.services.map((svc, idx) => _jsxs("tr", {
                                    ...
                                    children: [
                                        _jsx("td", { className: "px-[14px] py-[9px] font-sans text-[12px] text-tp-slate-400", children: idx + 1 }),
                                        _jsx("td", {
                                            className: "px-[8px] py-[9px]",
                                            children: _jsxs("div", {
                                                className: "space-y-[2px]",
                                                children: [
                                                    _jsx("p", { className: "font-sans text-[14px] font-medium text-tp-slate-800", children: svc.treatment }),
                                                    _jsx("p", { className: "font-sans text-[11px] text-tp-slate-400", children: svc.toothLabel }),
                                                ],
                                            }),
                                        }),
                                        _jsx("td", {
                                        ...
                                        _jsx("td", {
                                            ...
                                            children: svc.surfaces && svc.surfaces.length > 0
                                                ...
                                                : _jsx("span", { className: "font-sans text-[12px] text-tp-slate-300", children: "\u2014" }),
                                        }),
                                        _jsx("td", { className: "px-[8px] py-[9px] text-right font-sans text-[14px] text-tp-slate-600", children: formatINR(svc.rate) }),
                                        _jsx("td", {
                                            className: "px-[8px] py-[9px] text-right font-sans text-[12px] text-tp-slate-400",
                                            children: svc.discount > 0 ? `-${formatINR(svc.discount)}` : "—",
                                        }),
                                        _jsx("td", { className: "px-[14px] py-[9px] text-right font-sans text-[14px] font-semibold text-tp-slate-800", children: formatINR(svc.amount) }),
                                    ],
                                }, svc.id)),
                            }),
                            _jsx("tfoot", {
                                children: _jsxs("tr", {
                                    ...
                                    children: [
                                        _jsx("td", { colSpan: 6, className: "px-[14px] py-[9px] text-right font-sans text-[12px] font-semibold text-tp-slate-600", children: "Plan Total" }),
                                        _jsx("td", { className: "px-[14px] py-[9px] text-right font-sans text-[14px] font-bold text-tp-slate-700", children: formatINR(total) }),
                                    ],
                                }),
                            }),
                        ],
            ...
            isOpen && plan.services.length === 0 && _jsx("div", {
                ...
                children: _jsx("p", { className: "font-sans text-[12px] text-tp-slate-400", children: "No services added yet. Edit this plan to add services." }),
            }),
            _jsx(AlertDialog, {
                open: startOpen,
                    ...
                    _jsx("div", {
                        ...
                        children: _jsxs("div", {
                            ...
                            children: [
                                ...
                                _jsx("h3", { className: "font-sans text-[18px] font-bold text-tp-slate-900", children: "Plan Estimates" }),
                            ],
                        }),
                    }),
                    _jsx("div", {
