...
export function QuickSurfaceSelector({
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 114 229" className="quick-surface-svg">
        {/* Whole tooth section now comes from the provided SVG, no separate button/rect */}
        <path d={PATH_WHOLE} {...zoneProps('whole')} />
        {/* Crown wedges */}
        ...
        <circle cx={57} cy={92} r={20} {...zoneProps('occlusal')} />
