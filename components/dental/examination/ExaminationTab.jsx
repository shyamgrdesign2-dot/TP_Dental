    ...
    return (_jsxs("div", { className: ui.panelRoot, children: [
        _jsx("header", { className: ui.panelHeader, children: _jsxs("div", { className: ui.panelHeaderRow, children: [
            _jsxs("div", { className: ui.panelHeaderLeft, style: { minWidth: 0, flex: 1 }, children: [
                ...
                _jsx("div", { className: ui.panelTitleBlock, style: { minWidth: 0 }, children: _jsxs("div", { className: ui.panelTitleRow, children: [_jsx("h3", { className: ui.panelTitle, style: { overflow: "visible", maxWidth: "none" }, children: "Oral Examination" }), _jsx("span", { className: ui.panelBadge, style: { background: "rgba(75,74,213,0.10)", color: "var(--tp-blue-600, #3d3cb8)", border: "1px solid rgba(75,74,213,0.25)", textTransform: "capitalize" }, children: state.patientType ?? "adult" })] }) }),
            ] }),
